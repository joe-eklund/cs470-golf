...
"""autogenerated by genpy from sphero_swarm_node/SpheroOdometry.msg. Do not edit."""
import sys
...
class SpheroOdometry(genpy.Message):
  _md5sum = "6790b2093cea9b8cdd766b8f41653dfb"
  _type = "sphero_swarm_node/SpheroOdometry"
...
float64 z
"""
  __slots__ = ['header','name','child_frame_id','pose','twist']
  _slot_types = ['std_msgs/Header','string','string','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,child_frame_id,pose,twist
    ...
    """
    if args or kwds:
      super(SpheroOdometry, self).__init__(*args, **kwds)
