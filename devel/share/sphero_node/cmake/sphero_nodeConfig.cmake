...
if("TRUE" STREQUAL "TRUE")
  set(sphero_node_SOURCE_PREFIX /home/theta/catkin_ws/src/sphero_ros/sphero_node)
  set(sphero_node_DEVEL_PREFIX /home/theta/catkin_ws/devel)
  ...
  set(sphero_node_INSTALL_PREFIX /home/theta/catkin_ws/install)
...
if(NOT "/home/theta/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sphero_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/theta/catkin_ws/src/sphero_ros/sphero_node/${idir}'.  Ask the maintainer 'Melonee Wise <melonee@meloneewise.com>' to fix it.")
    endif()
...
set(sphero_node_EXPORTED_TARGETS "sphero_node_generate_messages_cpp;sphero_node_generate_messages_eus;sphero_node_generate_messages_lisp;sphero_node_generate_messages_py;sphero_node_gencfg")
